...
def send_message(message_id):
    ...
    if len(todays_messages) < max_messages:
        ...
        logging.debug("New message received, but the daily limit has been "
    ...
    try:
        ...
        logging.error("Attempt to send e-mail failed. Probably unable to "
                      "connect to smtp server %s: %s" % (type(e), e))
        return False
