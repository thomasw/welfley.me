...
class Project(models.Model):
    ...
    url_text = models.CharField(
        'URL text', max_length=255, default='See this in action', blank=True)
    ...
    flickr_embed_code = models.TextField(
        'Flickr Embed Code (supersedes screenshot)', blank=True)

    created = models.DateTimeField(auto_now=False, auto_now_add=True)
    modified = models.DateTimeField(
        'Last Modified', auto_now=True, auto_now_add=False)
